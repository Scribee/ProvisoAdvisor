               ...
               <div class="row">
                    <div>
                     ...
                     <form class="login_form" align='center' action="{{route('login.post')}}" method='POST'>
                         @csrf
                        <input class="login-input form-control enter" placeholder="Enter your email" type="text" name="email" id='email' required>
                        <input class="login-input form-control enter" placeholder="Enter your password" type="text" name="password" id= 'Password' required>
